...
const Price = (props) => {
  ...
  const changeValues = () => {
    if (price.current.lastValueProp) setPriceMinRange(price.current.value.min);
  ...
  return (
    <Fragment>
      ...
      <div className="grid grid-col-1 md:grid-cols-2 md:justify-center items-center overflow-hidden w-full mx-0">
        <div className="flex flex-col justify-center gap-7 border pb-16 pt-6 px-8 lg:px-10 w-full h-full">
          ...
          <div className="flex items-center gap-3 lg:gap-4">
            <div className="flex items-center gap-2 lg:gap-4">
              <span className="text-xxs lg:text-sm text-gray-500">EGP</span>
              <input
                type="text"
                placeholder={``}
                value={900000}
